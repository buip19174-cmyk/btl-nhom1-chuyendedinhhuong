    ...
    <section class="ranking-section">
      <div class="propose">
        <div class="propose-header">
          <h2>Truyền thuyết - Kinh dị</h2>
        </div>
        <div class="propose-container">
        <div class="book">
        <a href="read_story.php?story_id=258"><img src="t1.jpg" alt="">
      ...
      <div class="book">
        <a href="read_story.php?story_id=259"><img src="t2.jpg" alt="">
        <div class="title">Trò chơi đoạt mạng
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="259">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=260"><img src="t3.jpg" alt="">
        <div class="title">Cổ vật huyền bí
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="260">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=261"><img src="t4.jpg" alt="">
        <div class="title">Cầu cơ
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="261">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=262"><img src="t5.jpg" alt="">
        <div class="title">Đi đêm lắm có ngày gặp ma
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="262">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=263"><img src="t6.jpg" alt="">
        <div class="title">Ác duyên
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="263">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=264"><img src="t7.jpg" alt="">
        <div class="title">Tổng tài kể chuyện lúc 0h
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="264">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=265"><img src="t8.jpg" alt="">
        <div class="title">Tịch chiếu
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="265">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=266"><img src="t9.jpg" alt="">
        <div class="title">Trùng tang
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="266">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=267"><img src="t10.jpg" alt="">
        <div class="title">Nhật ký pháp y
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="267">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
