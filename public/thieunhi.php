...
<body>
  ...
  <div class="buttons">
    ...
    <div class="ranking-container">
      <!-- Book 1 -->
      <div class="book">
        <a href="read_story.php?story_id=104"><img src="tn1.png" alt="">
        <div class="title">Sam & Watson - Kết thúc để bắt đầu
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="104">
      ...
      <!-- Book 2 -->
      <div class="book">
        <a href="read_story.php?story_id=105"><img src="tn2.png" alt="">
        <div class="title">Chuyện nhà Okashiki - Chiếc khăn ma thuật
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="105">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 3 -->
      <div class="book">
        <a href="read_story.php?story_id=106"><img src="tn3.png" alt="">
        <div class="title">Mở cuốn sách này! - Unlock this book!
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="106">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 4 -->
      <div class="book">
        <a href="read_story.php?story_id=107"><img src="tn4.png" alt="">
        <div class="title">Aki nói cảm ơn
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="107">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 5 -->
      <div class="book">
        <a href="read_story.php?story_id=108"><img src="tn5.png" alt="">
        <div class="title">Hãy chia sẻ
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="108">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 6 -->
      <div class="book">
        <a href="read_story.php?story_id=109"><img src="tn6.png" alt="">
        <div class="title">Hãy xếp hàng
        <form action="luutruyen.php" method="POST" >
      ...
      <!-- Book 7 -->
      <div class="book">
        <a href="read_story.php?story_id=110"><img src="tn7.png" alt="">
        <div class="title">Voi ma-mút Moppet đi dã ngoại
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="110">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
