  ...
  <div class="buttons">
   <form action="timkiem.php" method="GET" class="search-form">
    ...
    <div class="ranking-container">
      <!-- Book 1 -->
      <div class="book">
        <a href=""><img src="ck1.jpg" alt="">
        <div class="title">Quyền lực mới</div></a>
        
        <div class="price-tag">178.000đ</div>
      </div>
      <!-- Book 2 -->
      <div class="book">
        <a href=""><img src="ck2.jpg" alt="">
  
        <div class="title">Cổ phiếu thường lợi nhuận phi thường</div></a>
        <div class="price-tag">109.000đ</div>
      </div>
      <!-- Book 3 -->
      <div class="book">
        <a href=""><img src="ck3.jpg" alt="">
      
        <div class="title">Chiến tranh tiền tệ</div></a>
        <div class="price-tag">89.000đ</div>
      </div>
      <!-- Book 4 -->
      <div class="book">
        <a href=""><img src="ck4.jpg" alt="">
        <div class="title">20 năm lịch sử thị trường chứng khoán Việt Nam</div></a>
        <div class="price-tag">109.000đ</div>
      </div>
      <!-- Book 5 -->
      <div class="book">
        <a href=""><img src="ck5.png" alt="">
        <div class="title">Hướng dẫn đầu tư chứng khoán từ A-Z</div></a>
        <div class="price-tag">79.000đ</div>
      </div>
      <!-- Book 6 -->
      <div class="book">
        <a href=""><img src="ck6.jpg" alt="">
        <div class="title">Ngợi ca sự tĩnh lặng</div></a>
        <div class="price-tag">109.000đ</div>
      </div>
  </div>
      </div>
