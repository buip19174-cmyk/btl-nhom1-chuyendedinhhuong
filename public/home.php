<?php
require_once dirname(__DIR__) . '/includes/bootstrap_web.php';
$books = load_all_books($conn);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="swiper bannerSwiper">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <img src="assets/img/ba2.webp" alt="">
            </div>

            <div class="swiper-slide">
                <img src="assets/img/ba1.webp" alt="">
            </div>

            <div class="swiper-slide">
                <img src="assets/img/sach2.jpg" alt="">
            </div>
