 ...
 <section class="ranking-section">
    <div class="ranking-header">
      ...
      <div class="ranking-container">
       ...
       <!-- Book 1 -->
        <div class="book">
          <a href="read_story.php?story_id=384">
            <img src="tp1.jpg" alt="">
            <div class="title">Phượng hồ
              <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="384">
        ...
        <!-- Book 2 -->
        <div class="book">
          <a href="read_story.php?story_id=385"
            ><img src="tp2.png" alt="" />
            
            <div class="title">Cưng chiều cô vợ quân nhân
              <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="385">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
        ...
        <!-- Book 3 -->
        <div class="book">
          <a href="read_story.php?story_id=386">
            <img src="tp3.png" alt="" />
           
            <div class="title">Siêu cấp cưng chiều
              <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="386">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
        ...
        <!-- Book 4 -->
        <div class="book">
          <a href="read_story.php?story_id=387">
            <img src="tp4.jpg" alt="" />
            
            <div class="title">Chọc tức vợ_mua 1 tặng 1
              <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="387">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
        ...
        <!-- Book 5 -->
        <div class="book">
          <a href="read_story.php?story_id=388">
            <img src="tp5.jpg" alt="" />
           
            <div class="title">Người dấu yêu
              <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="388">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
        ...
        <div class="book">
          <a href="read_story.php?story_id=389"
            ><img src="tp6.png" alt="" />
            
            <div class="title">Cứ yêu cứ chiều
              <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="389">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
        ...
        <div class="book">
          <a href="read_story.php?story_id=390"
            ><img src="tp7.png" alt="" />
            
            <div class="title">Bảo bối của ngài Tổng
              <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="390">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
        ...
        <div class="book">
          <a href="read_story.php?story_id=391"
            ><img src="yp8.png" alt="" />
          
            <div class="title">Đập nổi bán sắt đi học
              <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="391">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
        ...
        <div class="book">
          <a href="read_story.php?story_id=392"
            ><img src="tp9.png" alt="" />
           
            <div class="title">Nữ hoàng bệ hạ khuấy đảo showbiz
              <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="392">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
        ...
        <div class="book">
          <a href="read_story.php?story_id=393"
            ><img src="tp10.png" alt="" />
            
            <div class="title">Mở màn đã bị đuổi khỏi hào môn
              <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="393">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
    ...
    <div class="latest">
      ...
      <div class="latest-container">
        <div class="book">
          <a href="read_story.php?story_id=394"
            ><img src="m1.jpg" alt="Bìa sách" />
            
            <div class="title">Bay trên bầu trời nước Úc
              <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="394">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
        ...
        <div class="book">
          <a href="read_story.php?story_id=395"
            ><img src="m2.jpg" alt="Bìa sách" />
            
            <div class="title">Sức mạnh chữa lành của chánh niệm
              <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="395">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
        ...
        <div class="book">
          <a href="read_story.php?story_id=396"
            ><img src="m3.jpg" alt="Bìa sách" />
           
            <div class="title">Miếu ba cô
              <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="396">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
        ...
        <div class="book">
          <a href="read_story.php?story_id=397"
            ><img src="m4.jpg" alt="Bìa sách" />
            
            <div class="title">Khôn khéo không khó
              <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="397">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
        ...
        <div class="book">
          <a href="read_story.php?story_id=398"
            ><img src="m5.jpg" alt="Bìa sách" />
            
            <div class="title">Đỉnh tuyết
              <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="398">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
        ...
        <div class="book">
          <a href="read_story.php?story_id=399"
            ><img src="11.jpg" alt="Bìa sách" />
            
            <div class="title">Lớn lên con muốn làm tỷ phú
              <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="399">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
        ...
        <div class="book">
          <a href="read_story.php?story_id=400"
            ><img src="m6.png" alt="Bìa sách" />
           
            <div class="title">Để người thấu hiểu lòng tôi
              <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="400">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
        ...
        <div class="book">
          <a href="read_story.php?story_id=401"
            ><img src="13.jpg" alt="Bìa sách" />
            
            <div class="title">A Journal of the Plague
              <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="401">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
        ...
        <div class="book">
          <a href="read_story.php?story_id=402"
            ><img src="m7.jpg" alt="Bìa sách" />
           
            <div class="title">Mượn em một lần yêu
              <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="402">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
        ...
        <div class="book">
          <a href="read_story.php?story_id=403"
            ><img src="15.jpg" alt="Bìa sách" />
           
            <div class="title">Hell mode-Triệu hồi sư khởi nguyên
              <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="403">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
