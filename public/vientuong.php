    ...
    <section class="ranking-section">
      <div class="propose">
        <div class="propose-header">
          <h2>Viễn tưởng- Giả tưởng</h2>
        </div>
        <div class="propose-container">
        <div class="book">
        <a href="read_story.php?story_id=278"><img src="v1.jpg" alt="">
        <div class="title">Âm thanh và cuồng nộ
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="278">
      ...
      <div class="book">
        <a href="read_story.php?story_id=279"><img src="v2.jpg" alt="">
        <div class="title">Ác mộng trong đêm
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="279">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=280"><img src="v3.png" alt="">
        <div class="title">Dặm xanh
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="280">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=281"><img src="v4.jpg" alt="">
        <div class="title">451 độ F
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="281">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=282"><img src="v5.png" alt="">
        <div class="title">Cỗ máy thời gian
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="282">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=283"><img src="v6.jpg" alt="">
        <div class="title">Thời khắc
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="283">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=284"><img src="v7.jpg" alt="">
        <div class="title">Người sao chổi
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="284">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=285"><img src="p7.png" alt="">
        <div class="title">Phụ nữ quái sẽ yêu được đàn ông tốt
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="285">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=286"><img src="p10.png" alt="">
        <div class="title">Giác ngộ tài chính
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="286">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=287"><img src="p9.jpg" alt="">
        <div class="title">Làm chủ thời gian sống
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="287">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
