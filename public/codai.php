...
<body>
  ...
  <div class="buttons">
    ...
    <div class="ranking-container">
      <!-- Book 1 -->
      <div class="book">
        <a href="read_story.php?story_id=92"><img src="cd1.png" alt="">
        <div class="title">Vạn giới tiên tông
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="92">
      ...
      <!-- Book 2 -->
      <div class="book">
        <a href="read_story.php?story_id=93"><img src="cd2.png" alt="">
        <div class="title">PK đi vương giả
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="93">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 3 -->
      <div class="book">
        <a href="read_story.php?story_id=94"><img src="cd3.png" alt="">
        <div class="title">Chúa tể võ thần
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="94">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 4 -->
      <div class="book">
        <a href="read_story.php?story_id=95"><img src="cd4.png" alt="">
        <div class="title">Vương phi lại tán tỉnh ta rồi
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="95">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 5 -->
      <div class="book">
        <a href="read_story.php?story_id=96"><img src="cd5.png" alt="">
        <div class="title">Y phi cầm quyền
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="96">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 6 -->
      <div class="book">
        <a href="read_story.php?story_id=97"><img src="cd6.png" alt="">
        <div class="title">Hoàn khố cương phi muốn treo trên tường
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="97">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 7 -->
      <div class="book">
        <a href="read_story.php?story_id=98"><img src="cd7.png" alt="">
      ...
      <!-- Book 8 -->
      <div class="book">
        <a href="read_story.php?story_id=99"><img src="cd8.png" alt="">
        <div class="title">Quốc sư đại nhân
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="99">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 9 -->
      <div class="book">
        <a href="read_story.php?story_id=100"><img src="cd9.png" alt="">
        <div class="title">Vương gia muốn động phòng
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="100">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 10 -->
      <div class="book">
        <a href="read_story.php?story_id=101"><img src="cd10.png" alt="">
        <div class="title">Lung linh lang tam
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="101">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
    ...
    <!-- Book 11 -->
    <div class="book">
        <a href="read_story.php?story_id=102"><img src="cd11.png" alt="">
        <div class="title">Họa thời phi loạn
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="102">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
    ...
    <!-- Book 12 -->
    <div class="book">
        <a href="read_story.php?story_id=103"><img src="cd12.png" alt="">
        <div class="title">Điệp ảnh trùng trùng
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="103">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
