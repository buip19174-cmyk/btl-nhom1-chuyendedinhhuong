    ...
    <section class="ranking-section">
      <div class="propose">
        <div class="propose-header">
          <h2>Tác phẩm kinh điểm </h2>
        </div>
        <div class="propose-container">
        <div class="book">
        <a href="read_story.php?story_id=288"><img src="d1.png" alt="">
        <div class="title">Chiếc hộp giáng sinh
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="288">
      ...
      <div class="book">
        <a href="read_story.php?story_id=289"><img src="d2.png" alt="">
        <div class="title">Án mạng đêm giáng sinh
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="289">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=290"><img src="d3.png" alt="">
        <div class="title">Hồn ma đêm giáng sinh
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="290">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=291"><img src="d4.jpg" alt="">
        <div class="title">Chùm no thịnh nộ
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="291">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=292"><img src="d5.jpg" alt="">
        <div class="title">Chuông nguyền hồn ai
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="292">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=293"><img src="d6.png" alt="">
        <div class="title">Mười người da đen đỏ
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="293">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=294"><img src="v7.jpg" alt="">
        <div class="title">Người sao chổi
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="294">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=295"><img src="v6.png" alt="">
        <div class="title">Thư viện nửa đêm
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="295">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=296"><img src="p10.png" alt="">
        <div class="title">Giác ngộ tài chính
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="296">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=297"><img src="p9.jpg" alt="">
        <div class="title">Làm chủ thời gian sống
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="297">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
