...
<body>
  ...
  <div class="buttons">
    ...
    <div class="ranking-container">
      <!-- Book 1 -->
      <div class="book">
        <a href="read_story.php?story_id=123"><img src="hd1.png" alt="">
        <div class="title">Điệu thủ cuồng y
      ...
      <!-- Book 2 -->
      <div class="book">
        <a href="read_story.php?story_id=124"><img src="hd2.png" alt="">
        <div class="title">Vạn giới tiên tông
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="124">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 3 -->
      <div class="book">
        <a href="read_story.php?story_id=125"><img src="hd3.png" alt="">
        <div class="title">Tinh thần võ quyết
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="125">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 4 -->
      <div class="book">
        <a href="read_story.php?story_id=126"><img src="hd4.png" alt="">
        <div class="title">Kiến phệ long
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="126">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 5 -->
      <div class="book">
        <a href="read_story.php?story_id=127"><img src="hd5.png" alt="">
        <div class="title">Diệu thủ thiên y ở đô thị
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="127">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 6 -->
      <div class="book">
        <a href="read_story.php?story_id=128"><img src="hd6.png" alt="">
        <div class="title">Gia tộc lừa đảo
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="128">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 7 -->
      <div class="book">
        <a href="read_story.php?story_id=129"><img src="hd7.png" alt="">
        <div class="title">Tuyệt thể cổ tôn
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="129">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 8 -->
      <div class="book">
        <a href="read_story.php?story_id=130"><img src="hd8.png" alt="">
        <div class="title">Chúa tể trở về
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="130">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 9 -->
      <div class="book">
        <a href="read_story.php?story_id=131"><img src="hd9.png" alt="">
        <div class="title">Hỗn độn kim ô
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="131">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 10 -->
      <div class="book">
        <a href="read_story.php?story_id=132"><img src="hd10.png" alt="">
        <div class="title">Đại thần bỏ trốn của ta
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="132">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
    ...
    <!-- Book 11 -->
    <div class="book">
        <a href="read_story.php?story_id=133"><img src="hd11.png" alt="">
        <div class="title">Thâu thiên hoán nhật của Minh tướng quân
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="133">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
    ...
    <!-- Book 12 -->
    <div class="book">
        <a href="read_story.php?story_id=134"><img src="hd12.png" alt="">
        <div class="title">Thiết lập nhân vật của minh chủ đáng yêu sụp đổ rồi
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="134">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
