        ...
        <div class="propose-container">
          <div class="book">
            <a href=""
              ...
              <div class="price-tag">200.000đ</div>
              <div class="title">Sức mạnh của chữa lành chánh niệm</div></a
            >
          </div>

          <div class="book">
            <a href=""
              ><img src="p1.jpg" alt="Bìa sách" />
              <div class="price-tag">185.000đ</div>
              <div class="title">Khôn khéo không khó</div></a
            >
          </div>

          <div class="book">
            <a href=""
              ><img src="p2.jpg" alt="Bìa sách" />
              <div class="price-tag">135.000đ</div>
              <div class="title">Đỉnh tuyết</div></a
            >
          </div>

          <div class="book">
            <a href=""
              ><img src="p3.jpg" alt="Bìa sách" />
              <div class="price-tag">213.000đ</div>
              <div class="title">Tích cách con người</div></a
            >
          </div>

          <div class="book">
            <a href=""
              ><img src="p4.jpg" alt="Bìa sách" />
              <div class="price-tag">113.000đ</div>
              <div class="title">Sức mạnh phi thường của thói quen</div></a
            >
          </div>

          <div class="book">
            <a href=""
              ><img src="p5.jpg" alt="Bìa sách" />
              <div class="price-tag">245.000đ</div>
              <div class="title">Hack não hành vi</div></a
            >
          </div>

          <div class="book">
            <a href="">
              <img src="p6.png" alt="Bìa sách" />
              <div class="price-tag">326.000đ</div>
              <div class="title">Yêu đúng cách hạnh phúc đúng người</div></a
            >
          </div>
          ...
          <div class="book">
            <a href="">
              ...
              <div class="price-tag">245.000đ</div>
              <div class="title">Phụ nữ"quái" sẽ yêu được đàn ông tốt</div></a
            >
          </div>
          ...
          <div class="book">
            <a href=""
              ...
              <div class="price-tag">200.000đ</div>
              <div class="title">Giác ngộ tài chính</div></a
            >
          </div>
          ...
          <div class="book">
            <a href=""
              ...
              <div class="price-tag">99.000đ</div>
              <div class="title">Làm chủ thời gian sống</div></a
            >
          </div>
        </div>
      </div>
