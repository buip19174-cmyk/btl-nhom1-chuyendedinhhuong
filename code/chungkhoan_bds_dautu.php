    ...
    <section class="ranking-section">
      <div class="propose">
        ...
        <div class="propose-container">
          <!-- Book 1 -->
      <div class="book">
        <a href="read_story.php?story_id=224"><img src="l1.jpg" alt="">
        <div class="title">Những điều cần biết lúc lâm chung
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="224">
      ...
      <!-- Book 2 -->
      <div class="book">
        <a href="read_story.php?story_id=225"><img src="l2.jpg" alt="">
        <div class="title">Kiến thức sâu sắc
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="225">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 3 -->
      <div class="book">
        <a href="read_story.php?story_id=226"><img src="l3.jpg" alt="">
        <div class="title">Cầu cơ
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="226">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 4 -->
      <div class="book">
        <a href="read_story.php?story_id=227"><img src="l4.jpg" alt="">
        <div class="title">Ngũ uẩn và pháp hành tiền tuệ
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="227">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 5 -->
      <div class="book">
        <a href="read_story.php?story_id=228"><img src="s5.png" alt="">
        <div class="title">Kết nối bất kì ai
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="228">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 6 -->
      <div class="book">
        <a href="read_story.php?story_id=229"><img src="l5.jpg" alt="">
        <div class="title">Ngợi ca sự tĩnh lặng
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="229">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 7 -->
      <div class="book">
        <a href="read_story.php?story_id=230"><img src="l6.jpg" alt="">
        <div class="title">Lễ phật và Y học
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="230">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 8 -->
      <div class="book">
        <a href="read_story.php?story_id=231"><img src="l7.jpg" alt="">
        <div class="title">Kinh tình yêu của Narada
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="231">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 9 -->
      <div class="book">
        <a href="read_story.php?story_id=232"><img src="l8.jpg" alt="">
        <div class="title">Thần trú quản trị
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="232">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
	  ...
	  <!-- Book 10 -->
      <div class="book">
        <a href="read_story.php?story_id=233"><img src="t8.jpg" alt="">
        <div class="title">Tịch chiếu
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="233">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
