...
<body>
  ...
  <div class="buttons">
    ...
    <div class="ranking-container">
       <!-- Book 1 -->
      <div class="book">
        <a href="read_story.php?story_id=193"><img src="kh1.jpg" alt="">
        <div class="title">AI lắng nghe - Tôi trải lòng
          <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="193">
      ...
      <!-- Book 2 -->
      <div class="book">
        <a href="read_story.php?story_id=194"><img src="kh2.jpg" alt="">
        <div class="title">101 thí nghiệm tuyệt vời ông Mặt Trời
          <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="194">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 3 -->
      <div class="book">
        <a href="read_story.php?story_id=195"><img src="kh3.jpg" alt="">
        <div class="title">Huấn luyến não bộ
          <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="195">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 4 -->
      <div class="book">
        <a href="read_story.php?story_id=196"><img src="kh4.jpg" alt="">
        <div class="title">Kinh dịch dễ hiểu
          <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="196">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 5 -->
      <div class="book">
        <a href="read_story.php?story_id=197"><img src="kh5.jpg" alt="">
        <div class="title">10 vạn câu hỏi vì sao?
          <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="197">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 6 -->
      <div class="book">
        <a href="read_story.php?story_id=198"><img src="kh6.jpg" alt="">
        <div class="title">Câu đố bổ ích và lý thú
          <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="198">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 7 -->
      <div class="book">
        <a href="read_story.php?story_id=199"><img src="kh7.jpg" alt="">
        <div class="title">Vũ trụ trong vỏ hạt dẻ
          <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="199">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
