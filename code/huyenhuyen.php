...
<body>
  <header>
      ...
      <ul>
        <li>
          ...
          <div class="mega-menu">
            ...
            <div class="item"><a href="marketing_banhang.php">Marketing - Bán hàng</a> <span>NEW</span></div>
    ...
    <form action="timkiem.php" method="GET" class="search-form">
        <input type="text" name="query" placeholder="Tìm tên truyện..." required>
  ...
  <section class="ranking-section">
    <div class="propose">
      ...
      <div class="ranking-container">
        <!-- Book 1 -->
        <div class="book">
        <a href="read_story.php?story_id=85"><img src="hhuyen.png" alt="">
        <div class="title">Bình hoa di động
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="85">
        ...
        <!-- Book 2 -->
        <div class="book">
        <a href="read_story.php?story_id=86"><img src="hhuyen1.jpg" alt="">
        <div class="title">Tên anh là thời gian
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="86">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
        ...
        <!-- Book 3 -->
        <div class="book">
        <a href="read_story.php?story_id=87"><img src="hhuyen2.png" alt="">
        <div class="title">Mở màn đã bị đuổi khỏi hào môn
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="87">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
        ...
        <!-- Book 4 -->
        <div class="book">
        <a href="read_story.php?story_id=88"><img src="hhuyen3.jpg" alt="">
        <div class="title">Mèo nhỏ xuyên sách
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="88">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
        ...
        <!-- Book 5 -->
        <div class="book">
        <a href="read_story.php?story_id=89"><img src="hhuyen4.jpg" alt="">
        <div class="title">Yêu đi Giang tiểu thư
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="89">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
        ...
        <!-- Book 6 -->
        <div class="book">
        <a href="read_story.php?story_id=90"><img src="hhuyen5.jpg" alt="">
        <div class="title">Dược sư trùng sinh năm 1979
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="90">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
