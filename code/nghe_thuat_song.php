...
<body>
  ...
  <div class="buttons">
    ...
    <div class="ranking-container">
      <!-- Book 1 -->
      <div class="book">
        <a href="read_story.php?story_id=215"><img src="nts2.jpg" alt="">
        <div class="title">Sống nhẹ nhàng, hạnh phúc giản đơn
          <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="215">
      ...
      <!-- Book 2 -->
      <div class="book">
        <a href="read_story.php?story_id=216"><img src="nts3.jpg" alt="">
        <div class="title">Dopamine Detox
          <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="216">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 3 -->
      <div class="book">
        <a href="read_story.php?story_id=217"><img src="nts4.jpg" alt="">
        <div class="title">Người nhạy cảm và hành trình đi tìm bình yên
          <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="217">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 4 -->
      <div class="book">
        <a href="read_story.php?story_id=218"><img src="nts5.jpg" alt="">
        <div class="title">Bàn về cách sống
          <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="218">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 5 -->
      <div class="book">
        <a href="read_story.php?story_id=219"><img src="nts6.jpg" alt="">
        <div class="title">Sống thanh thản như người Thụy Điển
          <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="219">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 6 -->
      <div class="book">
        <a href="read_story.php?story_id=220"><img src="nts7.jpg" alt="">
        <div class="title">30 tuổi mọi thứ chỉ mới bắt đầu
          <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="220">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 7 -->
      <div class="book">
        <a href="read_story.php?story_id=221"><img src="nts8.jpg" alt="">
        <div class="title">Cân bằng công việc và cuộc sống
          <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="221">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 8 -->
      <div class="book">
        <a href="read_story.php?story_id=222"><img src="nts9.jpg" alt="">
        <div class="title">Tách khỏi đám đông
          <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="222">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 9 -->
      <div class="book">
        <a href="read_story.php?story_id=223"><img src="nts1.jpg" alt="">
        <div class="title">Tư duy ngược dịch chuyển thế giới
          <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="223">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
