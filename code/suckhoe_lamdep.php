...
<div class="user-area">
    ...
    <div class="ranking-container">
      <!-- Book 1 -->
      <div class="book">
        <a href="read_story.php?story_id=186"><img src="sk1.jpg" alt="">
        <div class="title">Thương những điều không hoàn hảo
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="186">
      ...
      <!-- Book 2 -->
      <div class="book">
        <a href="read_story.php?story_id=187"><img src="sk2.jpg" alt="">
        <div class="title">Cẩm nang sơ cấp cứu
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="187">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 3 -->
      <div class="book">
        <a href="read_story.php?story_id=188"><img src="sk3.jpg" alt="">
        <div class="title">Cẩm nang diện chẩn
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="188">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 4 -->
      <div class="book">
        <a href="read_story.php?story_id=189"><img src="sk4.jpg" alt="">
        <div class="title">Hướng dẫn thải độc & Chế độ ăn uống lành mạnh
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="189">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 5 -->
      <div class="book">
        <a href="read_story.php?story_id=190"><img src="sk5.jpg" alt="">
        <div class="title">Tâm hơn Thuốc
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="190">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 6 -->
      <div class="book">
        <a href="read_story.php?story_id=191"><img src="sk6.jpg" alt="">
        <div class="title">Bí ẩn của lão hóa
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="191">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 7 -->
      <div class="book">
        <a href="read_story.php?story_id=192"><img src="sk7.jpg" alt="">
        <div class="title">Việt Nam miền ngon
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="192">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
