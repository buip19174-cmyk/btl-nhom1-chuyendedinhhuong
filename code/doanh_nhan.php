    ...
    <section class="ranking-section">
      <div class="propose">
        <div class="propose-header">
          <h2>Doanh nhân - Bài học kinh doanh</h2>
        </div>
    <div class="ranking-container">
      <!-- Book 1 -->
      <div class="book">
        <a href="read_story.php?story_id=180"><img src="dn5.jpg" alt="">
        <div class="title">Tư duy kế toán phải có trong kinh doanh
		<form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="180">
      ...
      <!-- Book 2 -->
      <div class="book">
        <a href="read_story.php?story_id=181"><img src="dn1.jpg" alt="">
        <div class="title">Ngụ ngôn làm giàu
		<form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="181">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 3 -->
      <div class="book">
        <a href="read_story.php?story_id=182"><img src="dn2.jpg" alt="">
        <div class="title">Lớn lên con muốn làm tỷ phú
		<form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="182">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 4 -->
      <div class="book">
        <a href="read_story.php?story_id=183"><img src="dn3.jpg" alt="">
        <div class="title">Tứ thư lãnh đạo
		<form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="183">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 5 -->
      <div class="book">
        <a href="read_story.php?story_id=184"><img src="dn4.jpg" alt="">
        <div class="title">Làm chủ đồng tiền, tự do tài chính
		<form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="184">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 6 -->
      <div class="book">
        <a href="read_story.php?story_id=185"><img src="tccn4.jpg" alt="">
        <div class="title">LGiác ngộ tài chính
		<form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="185">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
