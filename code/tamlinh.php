    ...
    <section class="ranking-section">
      <div class="propose">
        ...
        <div class="propose-container">
          <!-- Book 1 -->
      <div class="book">
        <a href="read_story.php?story_id=241"><img src="tl1.jpg" alt="">
        <div class="title">Thần số học - Thấu hiểu nhân tâm
		<form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="241">
      ...
      <!-- Book 2 -->
      <div class="book">
        <a href="read_story.php?story_id=242"><img src="tl2.jpg" alt="">
        <div class="title">Muôn kiếp nhân sinh
		<form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="242">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 3 -->
      <div class="book">
        <a href="read_story.php?story_id=243"><img src="tl3.jpg" alt="">
        <div class="title">Thiền
		<form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="243">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 4 -->
      <div class="book">
        <a href="read_story.php?story_id=244"><img src="tl4.jpg" alt="">
        <div class="title">An nhiên giữa những thăng trầm
		<form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="244">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 5 -->
      <div class="book">
        <a href="read_story.php?story_id=245"><img src="tl5.jpg" alt="">
        <div class="title">Không diệt không sinh, đừng sợ hãi
		<form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="245">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 6 -->
      <div class="book">
        <a href="read_story.php?story_id=246"><img src="tl6.jpg" alt="">
        <div class="title">Con đường chuyển hóa
		<form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="246">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
