    ...
    <section class="ranking-section">
      <div class="propose">
        <div class="propose-header">
          <h2>Sách Ngoại Văn</h2>
        </div>
    <div class="ranking-container">
      <!-- Book 1 -->
      <div class="book">
        <a href="read_story.php?story_id=235"><img src="snv1.jpg" alt="">
        <div class="title">Twelve Years A Slave
		<form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="235">
      ...
      <!-- Book 2 -->
      <div class="book">
        <a href="read_story.php?story_id=236"><img src="snv2.jpg" alt="">
        <div class="title">Anne Of Avonlea
		<form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="236">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 3 -->
      <div class="book">
        <a href="read_story.php?story_id=237"><img src="snv3.jpg" alt="">
        <div class="title">The Story Of My Life
		<form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="237">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 4 -->
      <div class="book">
        <a href="read_story.php?story_id=238"><img src="snv4.jpg" alt="">
        <div class="title">Peter Pan And Wendy
		<form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="238">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 5 -->
      <div class="book">
        <a href="read_story.php?story_id=239"><img src="snv5.jpg" alt="">
        <div class="title">The Garden Party
		<form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="239">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 6 -->
      <div class="book">
        <a href="read_story.php?story_id=240"><img src="snv6.jpg" alt="">
        <div class="title">A Christmas Carol
		<form action="luutruyen.php" method="POST">
		<form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="240">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
