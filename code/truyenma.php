...
<body>
  ...
  <div class="buttons">
    ...
    <div class="ranking-container">
      <!-- Book 1 -->
      <div class="book">
        <a href="read_story.php?story_id=45"><img src="ma1.png" alt="">
        <div class="title">Vương bài thần côn
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="45">
      ...
      <!-- Book 2 -->
      <div class="book">
        <a href="read_story.php?story_id=46"><img src="ma2.png" alt="">
        <div class="title">Chuyến tàu ma quái
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="46">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 3 -->
      <div class="book">
        <a href="read_story.php?story_id=47"><img src="ma3.png" alt="">
        <div class="title">Sống chung với ma:Nhật ký rắc rối ở Yasaka
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="47">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
