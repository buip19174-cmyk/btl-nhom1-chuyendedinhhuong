...
<div class="container">
    ...
    <div class="tabs">
        ...
        <div class="tab-item">Sách điện tử</div>
        <div class="tab-item">Sách nói</div>
        <div class="tab-item">Truyện tranh</div>
        <div class="tab-item"> Cổ đại</div>
        <div class="tab-item">Hiện đại</div>
        <div class="tab-item">Trinh Thám - kinh dị</div>
        <div class="tab-item">Tài chính cá nhân</div>
    </div>
