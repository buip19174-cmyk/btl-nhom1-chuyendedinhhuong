  ...
  <div class="buttons">
    ...
    <section class="ranking-section">
      <div class="propose">
        ...
        <div class="book">
        <a href="read_story.php?story_id=318"><img src="m3.jpg" alt="">
        <div class="title">Miếu ba cô
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="318">
      ...
      <div class="book">
        <a href="read_story.php?story_id=319"><img src="n2.jpg" alt="">
        <div class="title">Mượn em một lần yêu
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="319">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=320"><img src="t2.jpg" alt="">
        <div class="title">Trò chơi đoạt mạng
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="320">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=321"><img src="s4.jpg" alt="">
        <div class="title">Cảm xúc cùng lúc là trí khôn
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="321">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=322"><img src="t6.jpg" alt="">
        <div class="title">Ác duyên
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="322">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=323"><img src="d6.png" alt="">
        <div class="title">Mười người da đen nhỏ
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="323">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=324"><img src="v7.jpg" alt="">
        <div class="title">Người sao chổi
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="324">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=325"><img src="v2.jpg" alt="">
        <div class="title">Ác mộng trong đêm
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="325">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=326"><img src="n1.png" alt="">
        <div class="title">Để người hiểu thấu lòng tôi
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="326">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=327"><img src="m2.jpg" alt="">
        <div class="title">Sức mạnh của chánh thiện
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="327">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
