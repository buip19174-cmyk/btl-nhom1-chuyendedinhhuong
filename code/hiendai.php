  ...
  <section class="ranking-section">
    <div class="propose">
      ...
      <div class="ranking-container">
        <!-- Book 1 -->
        <div class="book">
        <a href="read_story.php?story_id=71"><img src="hd.jpg" alt="">
        <div class="title">Rung cảm từ em
        ...
        <!-- Book 2 -->
        <div class="book">
        <a href="read_story.php?story_id=72"><img src="hdai1.png" alt="">
        <div class="title">Chạy trời không khỏi nắng
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="72">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
        ...
        <!-- Book 3 -->
        <div class="book">
        <a href="read_story.php?story_id=73"><img src="hdai2.png" alt="">
        <div class="title">Nữ hoàng hệ hạ khuấy đảo Showbiz
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="73">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
        ...
        <!-- Book 4 -->
        <div class="book">
        <a href="read_story.php?story_id=74"><img src="hdai3.jpg" alt="">
        <div class="title">Người yêu cũ là vợ tôi
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="74">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
        ...
        <!-- Book 5 -->
        <div class="book">
        <a href="read_story.php?story_id=75"><img src="d7.png" alt="">
        <div class="title">Trăm năm cô đơn
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="75">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
        ...
        <!-- Book 6 -->
        <div class="book">
        <a href="read_story.php?story_id=76"><img src="10.png" alt="">
        <div class="title">Tiểu yêu tinh của Bạc gia
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="76">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
        ...
        <!-- Book 7 -->
        <div class="book">
        <a href="read_story.php?story_id=77"><img src="b.jpg" alt="">
        <div class="title">Cưng chiều cô vợ quân nhân
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="77">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
