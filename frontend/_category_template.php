...
<section class="cat-hero">
    <!-- Text bên trái — cập nhật theo slide active -->
    <div class="cat-hero-text">
        <span class="cat-badge"><i class="fa-solid fa-bookmark"></i> <?= htmlspecialchars($page_title) ?></span>
        <h1 class="cat-hero-title" id="heroTitle">
            <?= htmlspecialchars($first_book['title'] ?? $page_title) ?>
        </h1>
        <p class="cat-hero-desc" id="heroDesc"><?= htmlspecialchars($hero_desc) ?></p>
        <div class="cat-hero-actions">
            <a href="<?= $first_book ? '../backend/read_story.php?story_id=' . $first_book['id'] : '#' ?>"
               class="cat-btn-read" id="heroReadBtn">
