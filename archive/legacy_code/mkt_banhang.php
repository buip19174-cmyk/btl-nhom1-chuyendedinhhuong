    ...
    <section class="ranking-section">
      <div class="propose">
        ...
        <div class="propose-container">
          ...
          <!-- Book 1 -->
		  <div class="book">
            <a href="read_story.php?story_id=155" ><img src="p10.png" alt="Bìa sách" />
              <div class="title">Giác ngộ tài chính
                <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="155">
...
<!-- Book 2-->
          <div class="book">
            <a href="read_story.php?story_id=156" ><img src="p1.jpg" alt="Bìa sách" />
             <div class="title">Khôn khéo không khó
			 <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="156">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
...
<!-- Book 3 -->
          <div class="book">
            <a href="read_story.php?story_id=157"><img src="k1.jpg" alt="Bìa sách" />
             <div class="title">Cách đàm phán và bán hàng
			 <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="157">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
...
<!-- Book 4 -->
           <div class="book">
            <a href="read_story.php?story_id=158"><img src="k2.jpg" alt="Bìa sách" />
             <div class="title">Doanh nghiệp nho nhỏ, món hời to to
			 <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="158">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
...
<!-- Book 5 -->
           <div class="book">
            <a href="read_story.php?story_id=159"><img src="k3.jpg" alt="Bìa sách" />
             <div class="title">Quyền lực biểu tượng
			 <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="159">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
...
<!-- Book 6 -->
           <div class="book">
            <a href="read_story.php?story_id=160"><img src="k4.jpg" alt="Bìa sách" />
             <div class="title">Thánh kinh marketing
			 <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="160">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
...
<!-- Book 7 -->
 <div class="book">
            <a href="read_story.php?story_id=161"><img src="k5.jpg" alt="Bìa sách" />
             <div class="title">Nuốt cá lớn
			 <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="161">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
...
<!-- Book 8 -->
           <div class="book">
            <a href="read_story.php?story_id=162"><img src="k6.jpg" alt="Bìa sách" />
             <div class="title">Marketing truyền miệng
			 <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="162">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
...
<!-- Book 9 -->
           <div class="book">
            <a href="read_story.php?story_id=163"><img src="k7.jpg" alt="Bìa sách" />
             <div class="title">Giáo án làm giàu
			 <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="163">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
...
<!-- Book 10 -->
           <div class="book">
            <a href="read_story.php?story_id=164"><img src="p9.jpg" alt="Bìa sách" />
             <div class="title">Làm chủ thời gian sống
              <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="164">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
