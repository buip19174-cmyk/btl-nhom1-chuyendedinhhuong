  ...
  <nav>
    <ul>
      ...
      <li>
        ...
        <div class="mega-menu">
            <h3>Sách hiệu </h3>
            <div class="item"><a href="">Hiện đại</a></div>
            <div class="item"><a href="">Cổ đại</a></div>
            <div class="item"><a href="">Huyền huyễn</a></div>
        </div>
      </li>
    <li>
        <a href="">Sách nói</a>
    ...
    <section class="ranking-section">
      <div class="propose">
        ...
        <div class="propose-container">
         <!-- Book 1 -->
      <div class="book">
        <a href="read_story.php?story_id=171"><img src="p1.jpg" alt="">
        <div class="title">Khôn khéo không khó
		<form action="luutruyen.php" method="POST">
		<input type ="hidden" name="story_id" value="171">
      ...
      <!-- Book 2 -->
      <div class="book">
        <a href="read_story.php?story_id=172"><img src="p2.jpg" alt="">
        <div class="title">Đỉnh tuyết
		<form action="luutruyen.php" method="POST">
		<input type ="hidden" name="story_id" value="172">
		<button type="submit" class="btn-save">
			<i class="fa-solid fa-heart"></i><button>
		</form>
		</div></a>
      ...
      <!-- Book 3 -->
      <div class="book">
        <a href="read_story.php?story_id=173"><img src="p3.jpg" alt="">
        <div class="title">Tích cách con người
		<form action="luutruyen.php" method="POST">
		<input type ="hidden" name="story_id" value="173">
		<button type="submit" class="btn-save">
			<i class="fa-solid fa-heart"></i><button>
		</form>
		</div></a>
      ...
      <!-- Book 4 -->
      <div class="book">
        <a href="read_story.php?story_id=174"><img src="p4.jpg" alt="">
        <div class="title">Sức mạnh phi thường của thói quen
		<form action="luutruyen.php" method="POST">
		<input type ="hidden" name="story_id" value="174">
		<button type="submit" class="btn-save">
			<i class="fa-solid fa-heart"></i><button>
		</form>
		</div></a>
      ...
      <!-- Book 5 -->
      <div class="book">
        <a href="read_story.php?story_id=175"><img src="p5.jpg" alt="">
        <div class="title">Hack não hành vi
		<form action="luutruyen.php" method="POST">
		<input type ="hidden" name="story_id" value="175">
		<button type="submit" class="btn-save">
			<i class="fa-solid fa-heart"></i><button>
		</form>
		</div></a>
      ...
      <!-- Book 6 -->
      <div class="book">
        <a href="read_story.php?story_id=176"><img src="p6.png" alt="">
        <div class="title">Yêu đúng cách hạnh phúc đúng người
		<form action="luutruyen.php" method="POST">
		<input type ="hidden" name="story_id" value="176">
		<button type="submit" class="btn-save">
			<i class="fa-solid fa-heart"></i><button>
		</form>
		</div></a>
      ...
      <!-- Book 7 -->
      <div class="book">
        <a href="read_story.php?story_id=177"><img src="p7.png" alt="">
        <div class="title">Phụ nữ"quái" sẽ yêu được đàn ông tốt
		<form action="luutruyen.php" method="POST">
		<input type ="hidden" name="story_id" value="177">
		<button type="submit" class="btn-save">
			<i class="fa-solid fa-heart"></i><button>
		</form>
		</div></a>
      ...
      <!-- Book 8 -->
      <div class="book">
        <a href="read_story.php?story_id=178"><img src="p8.png" alt="">
        <div class="title">Giác ngộ tài chính
		<form action="luutruyen.php" method="POST">
		<input type ="hidden" name="story_id" value="178">
		<button type="submit" class="btn-save">
			<i class="fa-solid fa-heart"></i><button>
		</form>
		</div></a>
      ...
      <!-- Book 9 -->
      <div class="book">
        <a href="read_story.php?story_id=179"><img src="p9.jpg" alt="">
        <div class="title">Làm chủ thời gian sống
		<form action="luutruyen.php" method="POST">
		<input type ="hidden" name="story_id" value="179">
		<button type="submit" class="btn-save">
			<i class="fa-solid fa-heart"></i><button>
		</form>
		</div></a>
