...
<body>
  ...
  <div class="buttons">
    ...
    <div class="ranking-container">
     <!-- Book 1 -->
      <div class="book">
        <a href="read_story.php?story_id=200"><img src="td1.jpg" alt="">
        <div class="title">Nghệ thuật thao túng tâm lý đen tối
           <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="200">
      ...
      <!-- Book 2 -->
      <div class="book">
        <a href="read_story.php?story_id=201"><img src="td2.jpg" alt="">
        <div class="title">Một cuốn sách về chủ nghĩa tối giản
           <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="201">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 3 -->
      <div class="book">
        <a href="read_story.php?story_id=202"><img src="td3.jpg" alt="">
        <div class="title">Tư duy đột phá
           <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="202">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 4 -->
      <div class="book">
        <a href="read_story.php?story_id=203"><img src="td4.jpg" alt="">
        <div class="title">Dám nghĩ lớn
           <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="203">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 5 -->
      <div class="book">
        <a href="read_story.php?story_id=204"><img src="td5.jpg" alt="">
        <div class="title">Từng chút đổi đời
           <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="204">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 6 -->
      <div class="book">
        <a href="read_story.php?story_id=205"><img src="td6.jpg" alt="">
        <div class="title">Nghĩ ngược, sống đỉnh
           <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="205">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 7 -->
      <div class="book">
        <a href="read_story.php?story_id=206"><img src="td7.jpg" alt="">
        <div class="title">Tư duy lởm khởm
           <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="206">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
