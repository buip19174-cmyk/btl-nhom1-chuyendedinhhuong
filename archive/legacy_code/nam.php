...
<body>
    ...
    <ul>
      <li>
        ...
        <div class="mega-menu">
            ...
            <div class="item"><a href="chungkhoan_bds_dautu.phpS">Chứng khoán - BĐS - Đầu tư</a></div>
  ...
  <div class="buttons">
    ...
    <div class="ranking-container">
      <!-- Book 1 -->
      <div class="book">
        <a href="read_story.php?story_id=1"><img src="n1.png" alt="">
        <div class="title">Để người hiểu thấu lòng tôi
      ...
      <!-- Book 2 -->
      <div class="book">
        <a href="read_story.php?story_id=2"><img src="n2.png" alt="">
        <div class="title">Vạn giới tiên tông
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="2">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 3 -->
      <div class="book">
        <a href="read_story.php?story_id=3"><img src="n3.png" alt="">
        <div class="title">Cô vợ nhỏ của ngài phó
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="3">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 4 -->
      <div class="book">
        <a href="read_story.php?story_id=4"><img src="n4.png" alt="">
        <div class="title">Gió xuân rực lửa
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="4">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 5 -->
      <div class="book">
        <a href="read_story.php?story_id=5"><img src="n5.png" alt="">
        <div class="title">Tinh võ thần quyết
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="5">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 6 -->
      <div class="book">
        <a href="read_story.php?story_id=6"><img src="n6.png" alt="">
        <div class="title">Hôn nhân quyền lực
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="6">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 7 -->
      <div class="book">
        <a href="read_story.php?story_id=7"><img src="n7.png" alt="">
      ...
      <!-- Book 8 -->
      <div class="book">
        <a href="read_story.php?story_id=8"><img src="n8.png" alt="">
        <div class="title">Chúa tể trở về
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="8">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 9 -->
      <div class="book">
        <a href="read_story.php?story_id=9"><img src="n9.png" alt="">
        <div class="title">Hỗn độn kim cô
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="9">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 10 -->
      <div class="book">
        <a href="read_story.php?story_id=10"><img src="n10.png" alt="">
        <div class="title">Chúa tể võ thần
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="10">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
    ...
    <!-- Book 11 -->
    <div class="book">
        <a href="read_story.php?story_id=11"><img src="n11.png" alt="">
        <div class="title">7 ngày đếm ngược
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="11">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
    ...
    <!-- Book 12 -->
    <div class="book">
        <a href="read_story.php?story_id=12"><img src="n12.png" alt="">
        <div class="title">Mẹ chạy mau cha đuổi tới rồi
        <form action="luutruyen.php" method="POST" >
    ...
    <!-- Book 13 -->  
    <div class="book">
        <a href="read_story.php?story_id=13"><img src="n13.png" alt="">
        <div class="title">Đóa hoa trong tuyết giả mạo của thần chiến tranh
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="13">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
    ...
    <!-- Book 14 -->  
    <div class="book">
        <a href="read_story.php?story_id=14"><img src="n14.png" alt="">
        <div class="title">Bài ca cứu thế
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="14">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
