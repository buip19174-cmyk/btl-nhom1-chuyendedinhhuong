...
<body>
      ...
      <li>
        ...
        <li>
          ...
          <div class="mega-menu">
            ...
            <div class="item"><a href="haihuoc">Hài </a></div>
  ...
  <section class="ranking-section">
    <div class="propose">
      ...
      <div class="ranking-container">
        <!-- Book 1 -->
        <div class="book">
        <a href="read_story.php?story_id=78"><img src="codai.jpg" alt="">
        <div class="title">Phật hệ học hư rồi
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="78">
        ...
        <!-- Book 2 -->
        <div class="book">
        <a href="read_story.php?story_id=79"><img src="hhuyen3.jpg" alt="">
        <div class="title">Mèo nhỏ xuyên sách
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="79">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
        ...
        <!-- Book 3 -->
        <div class="book">
        <a href="read_story.php?story_id=80"><img src="codai2.png" alt="">
        <div class="title">Trùng sinh trêu chọc chồng tương lai
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="80">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
        ...
        <!-- Book 4 -->
        <div class="book">
        <a href="read_story.php?story_id=81"><img src="codai3.png" alt="">
        <div class="title">Yêu chiều nóng bỏng
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="81">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
        ...
        <!-- Book 5 -->
        <div class="book">
        <a href="read_story.php?story_id=82"><img src="codai4.png" alt="">
        <div class="title">Túy hoa âm
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="82">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
        ...
        <!-- Book 6 -->
        <div class="book">
        <a href="read_story.php?story_id=83"><img src="codai5.jpg" alt="">
        <div class="title">Thịnh thế kiến y
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="83">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
        ...
        <!-- Book 7 -->
        <div class="book">
        <a href="read_story.php?story_id=84"><img src="codai6.png" alt="">
        <div class="title">Cô là người bị hại
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="84">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
  ...
  <div class="footer-bottom">
    Công ty Cổ phần Sách điện tử Weke – Tầng 6, Tháp văn phòng quốc tế Hòa Bình, số 106 đường Hoàng Quốc Việt, Phường
    Nghĩa Đô, Thành phố Hà Nội, Việt Nam.<br>
    ĐKKD số 0108796796 do SKHĐT TP Hà Nội cấp lần đầu ngày 24/06/2019.<br>
    Giấy xác nhận Đăng ký hoạt động phát hành xuất bản phẩm điện tử số 8132/XN-CXBIPH do Cục Xuất bản, In và Phát hành
    cấp ngày 31/12/2019.<br>
    Giấy chứng nhận Đăng ký kết nối để cung cấp dịch vụ nội dung thông tin trên mạng viễn thông di động số 91/GCN-CVT
    cấp ngày 24/03/2025.<br>
    </p>
  </div>
  </footer>
