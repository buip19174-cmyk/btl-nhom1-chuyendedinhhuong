    ...
    <section class="ranking-section">
      <div class="propose">
        <div class="propose-header">
          <h2>Tâm linh - Tôn giáo</h2>
        </div>
        <div class="propose-container">
        <div class="book">
        <a href="read_story.php?story_id=308"><img src="l1.jpg" alt="">
        <div class="title">Những điều cần biết khi lâm chung
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="308">
      ...
      <div class="book">
        <a href="read_story.php?story_id=309"><img src="l2.jpg" alt="">
        <div class="title">Kiến thức sâu sắc
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="309">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=310"><img src="l3.jpg" alt="">
        <div class="title">Cầu cơ
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="310">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=311"><img src="l4.jpg" alt="">
        <div class="title">Ngũ uẩn và pháp hành tiền tuệ
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="311">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=312"><img src="s5.png" alt="">
        <div class="title">Kết nối bất kì ai
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="312">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=313"><img src="l5.jpg" alt="">
        <div class="title">Ngợi ca sự tĩnh lặng
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="313">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=314"><img src="l6.jpg" alt="">
        <div class="title">Lễ pháp và Y học
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="314">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=315"><img src="l7.jpg" alt="">
        <div class="title">Kinh tình yêu của Narada
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="315">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=316"><img src="l8.jpg" alt="">
        <div class="title">Thần chú quản trị
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="316">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <div class="book">
        <a href="read_story.php?story_id=317"><img src="t8.jpg" alt="">
        <div class="title">Tịch chiếu
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="317">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
