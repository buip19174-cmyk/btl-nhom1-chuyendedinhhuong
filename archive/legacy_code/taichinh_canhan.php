...
<body>
  ...
  <div class="buttons">
    ...
    <div class="ranking-container">
      <!-- Book 1 -->
      <div class="book">
        <a href="read_story.php?story_id=165"><img src="tccn1.jpg" alt="">
        <div class="title">21 nguyên tắc tự do tài chính
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="165">
      ...
      <!-- Book 2 -->
      <div class="book">
        <a href="read_story.php?story_id=166"><img src="tccn2.jpg" alt="">
        <div class="title">Cách biến khả năng của bạn thành tiền
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="166">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 3 -->
      <div class="book">
        <a href="read_story.php?story_id=166"><img src="tccn3.jpg" alt="">
        <div class="title">Tiền và sự thật về kế hoạch hưu trí
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="167">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 4 -->
      <div class="book">
        <a href="read_story.php?story_id=168"><img src="tccn4.jpg" alt="">
        <div class="title">Giác ngộ tài chính
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="168">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 5 -->
      <div class="book">
        <a href="read_story.php?story_id=169"><img src="tccn5.jpg" alt="">
        <div class="title">Người giàu có nhất thành Babylon
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="169">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 6 -->
      <div class="book">
        <a href="read_story.php?story_id=170"><img src="tccn6.png" alt="">
        <div class="title">Bạn dùng tiền hay dùng bạn
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="170">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
