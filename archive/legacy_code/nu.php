...
<body>
  ...
  <nav>
    <ul>
      <li>
        ...
        <div class="mega-menu">
            ...
            <div class="item"><a href="chungkhoan.php">Chứng khoán - BĐS - Đầu tư</a></div>
    ...
    <li>
        ...
        <div class="mega-menu">
            ...
            <div class="item"><a href="thieunhi.php">Sách thiếu nhi</a></div>
  ...
  <div class="buttons">
    ...
    <div class="ranking-container">
      <!-- Book 1 -->
      <div class="book">
        <a href="read_story.php?story_id=15"><img src="nu1.png" alt="">
        <div class="title">Cô vợ gả thay
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="15">
      ...
      <!-- Book 2 -->
      <div class="book">
        <a href="read_story.php?story_id=16"><img src="nu2.png" alt="">
        <div class="title">USB kí ức
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="16">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 3 -->
      <div class="book">
        <a href="read_story.php?story_id=17"><img src="nu3.png" alt="">
        <div class="title">Bài ca cứu thế
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="17">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 4 -->
      <div class="book">
        <a href="read_story.php?story_id=18"><img src="nu4.png" alt="">
        <div class="title">Lừa hôn để thiếu cô dâu nhỏ ngọt ngào
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="18">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 5 -->
      <div class="book">
        <a href="read_story.php?story_id=19"><img src="nu5.png" alt="">
        <div class="title">Danh môn kinh hôn cố thiếu anh là đủ rồi!
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="19">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 6 -->
      <div class="book">
        <a href="read_story.php?story_id=20"><img src="nu6.png" alt="">
        <div class="title">Nam thần của tôi biến thân rồi
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="20">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 7 -->
      <div class="book">
        <a href="read_story.php?story_id=21"><img src="nu7.png" alt="">
        <div class="title">Lừa gạt thiếu gia quý tộc làm bạn trai
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="21">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 8 -->
      <div class="book">
        <a href="read_story.php?story_id=22"><img src="nu8.png" alt="">
        <div class="title">Bạn trai không tồn tại
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="22">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 9 -->
      <div class="book">
        <a href="read_story.php?story_id=23"><img src="nu9.png" alt="">
        <div class="title">PK đi vương giả
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="23">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 10 -->
      <div class="book">
        <a href="read_story.php?story_id=24"><img src="nu10.png" alt="">
        <div class="title">Báo bối ngây thơ của tài thiếu
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="24">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
    ...
    <!-- Book 11 -->
    <div class="book">
        <a href="read_story.php?story_id=25"><img src="nu11.png" alt="">
        <div class="title">Vợ cũ mất trí của tổng tài
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="25">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
    ...
    <!-- Book 12 -->
    <div class="book">
        <a href="read_story.php?story_id=26"><img src="nu12.png" alt="">
        <div class="title">Mẹ chạy mau đi cha đuổi tới rồi
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="26">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
    ...
    <!-- Book 13 -->  
    <div class="book">
        <a href="read_story.php?story_id=27"><img src="nu13.png" alt="">
        <div class="title">Lớp học bổ túc ban đêm của giáo viên hai mặt
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="27">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
    ...
    <!-- Book 14 -->  
    <div class="book">
        <a href="read_story.php?story_id=28"><img src="nu14.png" alt="">
        <div class="title">Ôm chặt quân chủ đại nhân của tôi
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="28">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
    ...
    <!-- Book 15 -->  
    <div class="book">
        <a href="read_story.php?story_id=29"><img src="nu15.png" alt="">
        <div class="title">Sống chung với ma:Nhật ký rắc rối ở Yasaka
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="29">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
    ...
    <!-- Book 16 -->  
    <div class="book">
        <a href="read_story.php?story_id=30"><img src="nu16.png" alt="">
        <div class="title">Ái phi tái thế
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="30">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
    ...
    <!-- Book 17 -->  
    <div class="book">
        <a href="read_story.php?story_id=31"><img src="nu17.png" alt="">
        <div class="title">Quý cô này cô chút tâm cơ
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="31">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
    ...
    <!-- Book 18 -->  
    <div class="book">
        <a href="read_story.php?story_id=32"><img src="nu18.png" alt="">
        <div class="title">Điện hạ ma cà rồng thần yêu
        <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="31">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
