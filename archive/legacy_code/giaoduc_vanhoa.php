    ...
    <section class="ranking-section">
      <div class="propose">
        <div class="propose-header">
          <h2>Giáo dục - Văn hóa & Xã hội</h2>
        </div>
    <div class="ranking-container">
      <!-- Book 1 -->
      <div class="book">
        <a href="read_story.php?story_id=207"><img src="gd1.jpg" alt="">
        <div class="title">Thánh Nhân đê tiện
          <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="207">
      ...
      <!-- Book 2 -->
      <div class="book">
        <a href="read_story.php?story_id=208"><img src="gd2.jpg" alt="">
        <div class="title">[Tóm tắt sách] Điện Biên Phủ
          <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="208">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 3 -->
      <div class="book">
        <a href="read_story.php?story_id=209"><img src="gd3.jpg" alt="">
        <div class="title">[Tóm tắt sách] Đường Bác Hồ đi cứu nước
          <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="209">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 4 -->
      <div class="book">
        <a href="read_story.php?story_id=210"><img src="gd4.jpg" alt="">
        <div class="title">77 tình hướng giao tiếp Tiếng Anh cơ bản
          <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="210">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 5 -->
      <div class="book">
        <a href="read_story.php?story_id=211"><img src="gd5.jpg" alt="">
        <div class="title">Sức mạnh của lòng trung thực
          <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="211">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 6 -->
      <div class="book">
        <a href="read_story.php?story_id=212"><img src="gd6.jpg" alt="">
        <div class="title">Hồi ức phi công tiêm kích
          <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="212">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 7 -->
      <div class="book">
        <a href="read_story.php?story_id=213"><img src="gd7.jpg" alt="">
        <div class="title">Sức mạnh chữa lành của chánh niệm
          <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="213">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
      ...
      <!-- Book 8 -->
      <div class="book">
        <a href="read_story.php?story_id=214"><img src="gd8.jpg" alt="">
        <div class="title">Phép màu tuổi thơ
          <form action="luutruyen.php" method="POST" >
        <input type="hidden" name="story_id" value="214">
        <button type="submit" class="btn-save">
            <i class="fa-solid fa-heart" ></i>
        </button>
        </form>
