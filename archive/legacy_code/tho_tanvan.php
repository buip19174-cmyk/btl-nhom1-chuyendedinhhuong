...
<body>
  ...
  <div class="buttons">
    ...
    <div class="ranking-container">
      <!-- Book 1 -->
      <div class="book">
        <a href="read_story.php?story_id=135"><img src="tv1.jpg" alt="">
        <div class="title">Đừng vì cô đơn mà nắm vội một bàn tay
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="135">
      ...
      <!-- Book 2 -->
      <div class="book">
        <a href="read_story.php?story_id=136"><img src="tv2.jpg" alt="">
        <div class="title">Yêu thương mẹ kể
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="136">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 3 -->
      <div class="book">
        <a href="read_story.php?story_id=137"><img src="tv3.jpg" alt="">
        <div class="title">Đêm nay con có mơ không?
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="137">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 4 -->
      <div class="book">
        <a href="read_story.php?story_id=138"><img src="tv4.jpg" alt="">
        <div class="title">Em đâu muốn làm Tuesday
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="138">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 5 -->
      <div class="book">
        <a href="read_story.php?story_id=139"><img src="tv5.jpg" alt="">
        <div class="title">Mẹ là lửa ấm <br> Con là khói xa
        <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="139">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 6 -->
      <div class="book">
        <a href="read_story.php?story_id=140"><img src="tv6.jpg" alt="">
        <div class="title">Mình buồn đủ rồi mình hạnh phúc thôi
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="140">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 7 -->
      <div class="book">
        <a href="read_story.php?story_id=141"><img src="tv7.jpg" alt="">
        <div class="title">Qua những vần thơ
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="141">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 8 -->
      <div class="book">
        <a href="read_story.php?story_id=142"><img src="tv8.jpg" alt="">
        <div class="title">Góc sân và Khoảng trời
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="142">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 9 -->
      <div class="book">
        <a href="read_story.php?story_id=143"><img src="tv9.jpg" alt="">
        <div class="title">Tuyển tập thơ của Lưu Quang Vũ
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="143">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
      ...
      <!-- Book 10 -->
      <div class="book">
        <a href="read_story.php?story_id=144"><img src="tv10.jpg" alt="">
        <div class="title">Đi học Hà Nội
          <form action="luutruyen.php" method="POST">
                <input type="hidden" name="story_id" value="144">
                <button type="submit" class="btn-save">
                  <i class="fa-solid fa-heart"></i>
                </button>
              </form>
