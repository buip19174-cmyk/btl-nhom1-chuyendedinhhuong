...
- [x] Đọc 3 chương đầu miễn phí; chương 4 yêu cầu coin
- [x] Nạp coin qua QR → số dư tăng
- [x] Mua chương → đọc được nội dung
- [x] Lưu truyện vào tủ sách
- [x] Bình luận & trả lời bình luận
- [x] Tìm kiếm theo tên truyện (AJAX dropdown + trang kết quả)
- [x] Admin: CRUD truyện, chương, user
- [x] Admin: quản lý bình luận, xem dashboard và thống kê
- [x] Admin: bypass đọc chương trả phí không cần mua
- [x] Admin: dropdown chỉ hiển thị "Quản trị viên" (không có Tủ sách / Nạp Coin)
- [x] User bị `banned` không đăng nhập được
- [x] `luot_xem` tăng mỗi lần mở trang truyện
...
| **Nhóm**                 | Nhóm 1                                       |
| **Tên thành viên**       |-Lê Thúy Hằng -Bùi Phương Anh -Nguyễn Đức Lâm |
