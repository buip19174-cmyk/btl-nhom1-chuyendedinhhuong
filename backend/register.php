...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($username)) {
        ...
        $errors['username'] = 'Tên đăng nhập từ 6-20 ký tự, chỉ chứa chữ cái, số và gạch dưới.';
    }
...
<body>
    <header>
        ...
        <nav>
            ...
            <a href="bookmarks.php">Tủ sách</a>
        </nav>
    </header>
        ...
        <div class="register-box">
            ...
            <?php if (isset($errors['system'])): ?>
                <div class="error-message"
                    style="border: 1px solid #dc3545; padding: 10px; margin-bottom: 15px; background: #fff5f5;">
            ...
            <form action="register.php" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" id="username" name="username" value="<?php echo htmlspecialchars($username); ?>"
                        placeholder="Ví dụ: nva_2025" required>
                    <?php if (isset($errors['username']))
                        echo '<div class="error-message">' . $errors['username'] . '</div>'; ?>
                </div>
                ...
                <div class="form-group">
                    ...
                    <?php if (isset($errors['confirm_password']))
                        echo '<div class="error-message">' . $errors['confirm_password'] . '</div>'; ?>
                </div>

                <button type="submit" class="btn-register">TẠO TÀI KHOẢN</button>
            </form>

            <p style="text-align: center; margin-top: 20px; color: #666;">Đã có tài khoản? <a href="login.php"
                    style="color: #007bff; text-decoration: none;">Đăng nhập ngay</a></p>
        </div>
    </main>

    <footer>
        <p>&copy; Kết nối những người thích đọc truyện lại với nhau</p>
    </footer>
</body>
