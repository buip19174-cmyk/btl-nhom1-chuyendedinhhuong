...
<body>
    ...
    <main class="container">
        <div class="login-box">
            ...
            <?php if (isset($errors['system'])): ?>
                <div class="error-message" style="border: 1px solid red; padding: 10px;">
                    <?php echo htmlspecialchars($errors['system']); ?>
                </div>
            <?php endif; ?>

            <?php if (isset($errors['login'])): ?>
                <div class="error-message" style="padding: 10px; text-align: center;">
            ...
            <p style="text-align: center; margin-top: 15px;">Chưa có tài khoản? <a href="register.php">Đăng ký ngay</a>
            </p>
        </div>
    </main>
    ...
    <footer>
        <div class="container">
            <p>&copy;  Website Đọc Truyện Trực Tuyến</p>
            <div class="contact-info">
                <h4>Thông tin Liên hệ</h4>
                <p>Địa chỉ: 18 Đường phố Viên, Quận Bắc Từ Liêm, Hà Nội</p>
                <p>Hotline: 0987.654.321</p>
                <p>Email: hotro@webtruyen.vn</p>
            </div>
        </div>
    </footer>
</body>
