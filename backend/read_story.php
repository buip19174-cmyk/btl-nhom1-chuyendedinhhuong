...
<body>
   ...
   <aside class="sidebar">
    <a href="../frontend/home.php" title="Trang chủ">
        <i class="fa-solid fa-house"></i>
    </a>

    <a href="../frontend/tusach.php" class="active" title="Tủ sách">
        <i class="fa-solid fa-book"></i>
    </a>

    <a href="../frontend/taikhoan.php" title="Tài khoản">
    ...
    <main class="main">
        <div class="story-info-header">
           <img src="../code/images/<?php echo htmlspecialchars($story['cover']); ?>" class="cover-mini">
            <div class="details">
